...
public class QuartzIntervals {
	...
	public static final String CONSUMER_CRON_JOB = "1 * * * * ?";
	public static final String SMART_CONSUMER_CRON_JOB = "1 * * * * ?";
	public static final String PRODUCER_CRON_JOB = "1 * * * * ?";
	public static final String STORAGE_CRON_JOB = "1 * * * * ?";
